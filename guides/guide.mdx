...
```bash cURL
curl -X GET https://api.figenty.com/public/v1/invoices/inv_abc123def456/status \
  -H "x-api-key: YOUR_API_KEY"
```

```javascript JavaScript
const response = await fetch(
  'https://api.figenty.com/public/v1/invoices/inv_abc123def456/status',
  {
    headers: {
      'x-api-key': 'YOUR_API_KEY'
    }
...
```bash cURL
curl -X GET https://api.figenty.com/public/v1/invoices/inv_abc123def456 \
  -H "x-api-key: YOUR_API_KEY"
```

```javascript JavaScript
const response = await fetch(
  'https://api.figenty.com/public/v1/invoices/inv_abc123def456',
  {
    headers: {
      'x-api-key': 'YOUR_API_KEY'
    }
...
```bash cURL
curl -X PATCH https://api.figenty.com/public/v1/invoices/inv_abc123def456 \
  -H "x-api-key: YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
